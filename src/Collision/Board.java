...
public class Board extends JPanel implements Runnable {
    ...
    public Board() {
        ...
        //      Put this outside initBoard()
        //      so that the listeners won't be duplicated in a new game
...
//		repaint();
    ...
    private class GameKeyAdapter extends KeyAdapter {
        public void keyReleased(KeyEvent e) {
            if (gameState==GSTATE.GAME){craft.keyReleased(e);}
        }
    ...
    private class GameMouseAdapter extends MouseAdapter {
        public void mouseClicked(MouseEvent e) {
            ...
            if (gameState == GSTATE.MENU) {
                ...
                if (isPaused) {
                    if (mx > pauseMenu.bounds.get(0)[0] && mx < pauseMenu.bounds.get(0)[1] && my > pauseMenu.bounds
                            .get(0)[2] && my < pauseMenu.bounds.get(0)[3]) {
                        newGame();
                    } else if (mx > pauseMenu.bounds.get(1)[0] && mx < pauseMenu.bounds.get(1)[1] && my > pauseMenu
                            .bounds.get(1)[2] && my < pauseMenu.bounds.get(1)[3]) {
                        System.exit(1);
                    }
                }else if (isWin){
                    if (mx > winMenu.bounds.get(0)[0] && mx < winMenu.bounds.get(0)[1] && my > winMenu.bounds
                            .get(0)[2] && my < winMenu.bounds.get(0)[3]) {
                        newGame();
                    } else if (mx > winMenu.bounds.get(1)[0] && mx < winMenu.bounds.get(1)[1] && my > winMenu
                            .bounds.get(1)[2] && my < winMenu.bounds.get(1)[3]) {
                        System.exit(1);
                    }
                }else if (isLose){
                    if (mx > loseMenu.bounds.get(0)[0] && mx < loseMenu.bounds.get(0)[1] && my > loseMenu.bounds
                            .get(0)[2] && my < loseMenu.bounds.get(0)[3]) {
                        newGame();
                    } else if (mx > loseMenu.bounds.get(1)[0] && mx < loseMenu.bounds.get(1)[1] && my > loseMenu
                            .bounds.get(1)[2] && my < loseMenu.bounds.get(1)[3]) {
                        System.exit(1);
                    }
                }
            }
